...
async function plot(polygon) {
  ...
  for (let i = 0; i < polygon.features.length; i++) {
    ...
    ctx.beginPath();
    path(feature);
    // TODO: fill style is not working fills in the entire map are the polygons generated by h3 not closed? Also the line order could be reversed
    // ctx.fillStyle = "#ff0";
    // ctx.fill();
  ...
  await writeFile(join(__dirname, "../../test/screenshots/test_2.png"), buf2);
  return buf2;
}
